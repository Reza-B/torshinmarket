		...
		<Box
			...
			<Box
				...
				<Box pt={0.5}>
					{variant === "special" ? (
						...
						<svg
							...
							xmlns="http://www.w3.org/2000/svg">
							<path
								d="M11.3866 24.509L0.490942 13.6134C-0.163647 12.9588 -0.163647 11.8974 0.490942 11.2428L2.86146 8.8722C3.51605 8.21754 4.57746 8.21754 5.23205 8.8722L12.5719 16.212L28.2929 0.490942C28.9475 -0.163647 30.0089 -0.163647 30.6635 0.490942L33.034 2.86153C33.6886 3.51612 33.6886 4.57746 33.034 5.23211L13.7572 24.5091C13.1025 25.1637 12.0412 25.1637 11.3866 24.509Z"
								fill="#009B19"
							/>
						</svg>
					)}
				...
				<Typography
					fontWeight="bold"
					variant="h5"
					color={variant === "special" ? "#f00" : "#009A49"}>
