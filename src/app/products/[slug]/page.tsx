							...
							<Box my={3}>
								<Box
									...
									<Box
										...
										<Typography mx={1}>{"رضا بوذرجمهری"}</Typography>
										<svg
											width="16"
											height="16"
											viewBox="0 0 24 24"
								...
								<Typography
									...
									textAlign="justify">
									{
										"لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است، و برای شر کتاب های زیادی"
									}
								</Typography>
							</Box>
							<Box my={3}>
